-- Time is Money — REBUILD completo (apaga tudo e recria 0000→0014)
-- Neon SQL Editor: cole o arquivo INTEIRO e Run uma vez.
-- Depois: onboarding no app (cria household + seed).

DROP SCHEMA IF EXISTS public CASCADE;
CREATE SCHEMA public;
GRANT ALL ON SCHEMA public TO public;
DO $$ BEGIN
  EXECUTE 'GRANT ALL ON SCHEMA public TO neon_superuser';
EXCEPTION
